...
public class MessageController {
    ...
    @Operation(summary = "Get messages with one user",
    ...
    public List<MessageDto> getPrivateMessages(@PathVariable int userId,
        ...
        return messageService.getCorrespondence(authUser, userId, pageNumber, pageSize).stream()
                .map(MessageDto::new)
                .toList();
    }
    ...
    @ApiResponses({
            ...
            @ApiResponse(description = "Bad request", responseCode = "400", content = @Content),
            @ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
            @ApiResponse(description = "Cannot send a message", responseCode = "403", content = @Content),
            @ApiResponse(description = "A receiver or a replied message not found", responseCode = "404", content = @Content)
    })
    ...
    public MessageDto sendMessage(@RequestBody MessageRequestDto dto,
        ...
        return new MessageDto(messageService.sendMessage(sender, dto));
    }
    ...
    @ApiResponses({
            ...
            @ApiResponse(description = "Bad request", responseCode = "400", content = @Content),
            @ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
            @ApiResponse(description = "Cannot edit a message", responseCode = "403", content = @Content),
    ...
    public MessageDto editMessage(@RequestBody MessageUpdateRequestDto dto,
        ...
        return new MessageDto(messageService.edit(messageId, dto, requester));
    }
    ...
    @ApiResponses({
            ...
            @ApiResponse(description = "Bad request", responseCode = "400", content = @Content),
            @ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
            @ApiResponse(description = "Cannot delete a message", responseCode = "403", content = @Content),
            @ApiResponse(description = "Message not found or already deleted", responseCode = "404", content = @Content)
    })
    ...
    public void deleteMapping(@PathVariable int messageId,
        ...
        UserEntity requester = userEntityService.getUserByUserDetails(userDetails);
        messageService.delete(messageId, requester);
    }
}
